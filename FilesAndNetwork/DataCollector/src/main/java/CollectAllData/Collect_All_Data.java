...
public class Collect_All_Data {
    ...
    private static Parse_CSV parseCsv = new Parse_CSV();
    private static Parse_JSON_Files parseJsonFiles = new Parse_JSON_Files();
    private static ParseHTML parseHTML = new ParseHTML();
